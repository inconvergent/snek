...
(let ((pts-a (list (vec:vec -20.0d0 99.0d0)
    ...
    (do-test
      ...
      (list (vec:vec -10.084970357192768d0 51.903581889280694d0)
            (vec:vec 72.94161639142135d0 70.67347981875083d0)
            (vec:vec -9.972643319179287d0 49.8660159205005d0)
            (vec:vec 4.718551216740963d0 -4.763338116541956d0)
            (vec:vec 35.77978017789252d0 42.62675016658847d0)))
